...
//             alt={product?.title}
//             className={`w-full h-[300px] object-contain transition-transform duration-300 ease-in-out ${isHovered ? "scale-110" : "scale-100"}`}
//           />
//         </div>
//         <div
...
//                 Rs {product?.price}
//               </span>
//               {product?.salePrice > 0 && <span className="text-lg font-bold text-red-500">Rs {product?.salePrice}</span>}
//             </div>
//           </div>
//         </div>
//       </div>
...
//       {/* <CardFooter className="flex justify-between items-center">
//         <Button
//           className="bg-black text-white hover:bg-gray-800 transition-colors duration-300 mt-2"
//           onClick={() => {
//             setOpenCreateProductsDialog(true)
//             setCurrentEditedId(product?._id)
//             setFormData(product)
...
//         </Button>
//         <Button
//           className="bg-red-600 text-white hover:bg-red-700 transition-colors duration-300 mt-2"
//           onClick={() => handleDelete(product?._id)}
//         >
//           Delete
//         </Button>
...
//   <Button
//     className="flex-1 px-6 py-2 bg-black text-white font-medium rounded-lg shadow-md hover:bg-gray-900 transition-all duration-300"
//     onClick={() => {
//       setOpenCreateProductsDialog(true)
//       setCurrentEditedId(product?._id)
//       setFormData(product)
...
//   </Button>
//   <Button
//     className="flex-1 px-6 py-2 bg-red-600 text-white font-medium rounded-lg shadow-md hover:bg-red-700 transition-all duration-300"
//     onClick={() => handleDelete(product?._id)}
//   >
  ...
  return (
    ...
    >
      ...
      {/* <CardContent className="bg-white p-4">
        <h2 className="text-xl font-semibold mb-1">{product?.title}</h2>
        <div className="flex justify-between items-center mb-2">
          <span className={`${product?.salePrice > 0 ? "line-through text-gray-500" : "text-green-600"}   `}>
            Rs {product?.price}
          </span>
          {product?.salePrice > 0 && <span className="text-lg font-bold text-red-500">Rs {product?.salePrice}</span>}
        </div>
