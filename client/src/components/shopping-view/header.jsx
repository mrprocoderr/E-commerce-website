    ...
    return (
      <div className="flex lg:items-center lg:flex-row flex-col gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent side="right" className="w-56 bg-white border border-gray-200 rounded-lg shadow-lg p-2">
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b bg-background">
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <span className="font-bold text-xl">Modern Hub</span>
        </Link>
        <Sheet>
        <SheetTrigger asChild>
          ...
          <SheetContent side="left" className="overflow-auto bg-white shadow-lg rounded-lg p-5 md:w-1/3 lg:w-1/4">
             <MenuItems />
            <HeaderRightContent />
          </SheetContent>
        </Sheet>
