    ...
    dispatch(
      ...
      if (data?.payload?.success) {
        ...
        toast({
          ...
          className:
          "bg-green-500 text-white shadow-lg px-4 py-2 rounded-lg fixed bottom-5 right-5 sm:right-14 w-[90%] sm:w-[350px] max-w-[350px]",
          duration: 4000,
        })
      }
    })
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        <div className="relative w-full max-w-xl">
          <Input
            ...
            className="py-6 pl-12 pr-12 text-lg rounded-full shadow-md"
      ...
      <AnimatePresence>
        {loading ? (
          ...
          <motion.h1
            className="text-4xl font-extrabold text-center text-gray-600"
